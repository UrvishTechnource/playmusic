...
//            ->addViewsCount()
	...
	$collection->setVisibility($this->_catalogProductVisibility->getVisibleInCatalogIds());
        $collection = $this->_addProductAttributesAndPrices($collection);
        if(isset($_SESSION['mostPopularCat2'])){
        $collection->addCategoriesFilter(['in' => $_SESSION['mostPopularCat2']]);
    ...
    protected function _getBestsellersProducts($collection)
    {
        ...
        $collection->setVisibility($this->_catalogProductVisibility->getVisibleInCatalogIds());
        $collection = $this->_addProductAttributesAndPrices($collection);
        if(isset($_SESSION['mostPopularCat'])){
        $collection->addCategoriesFilter(['in' => $_SESSION['mostPopularCat']]);
